  ...
  if (status_code == 0) { // STATUS_OK
    ...
    printPgmString(PSTR("error: "));
      ...
      switch(status_code) {          
		...
		case STATUS_LASER_INVALID_VALUE:
		printPgmString(PSTR("Invalid laser power")); break;
        default:
...
void report_alarm_message(uint8_t alarm_code)
{
  printPgmString(PSTR("ALARM: "));
    ...
    switch (alarm_code) {
	  ...
	  case ALARM_COOLANT_OFF:
	  printPgmString(PSTR("Coolant OFF")); break;
	  case ALARM_LASER_TEMP:
	  printPgmString(PSTR("Temp laser too high")); break;
    }
  #endif
  printPgmString(PSTR("\r\n"));
...
void report_grbl_help() {
    ...
    printPgmString(PSTR("$$ (view Grbl settings)\r\n"
						...
						"%x=value (set Grbl setting - NOT SAVED)\r\n"
...
void report_grbl_settings() {
  // Print Grbl settings.
	...
	printPgmString(PSTR("\r\n$28=")); printFloat_SettingValue(laserPowerSettings);
    printPgmString(PSTR("\r\n"));
  #else      
    printPgmString(PSTR("$0=")); print_uint8_base10(settings.pulse_microseconds);
	...
	printPgmString(PSTR(" (homing pull-off, mm)\r\n$28=")); print_uint8_base10(laserPowerSettings);	// JDU - 20161113
	printPgmString(PSTR(" (laser power divisor, %) -- NOT SAVED\r\n"));
  #endif
